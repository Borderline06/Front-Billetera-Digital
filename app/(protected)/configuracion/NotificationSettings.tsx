  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 rounded-lg p-6 transition-all duration-300 hover:bg-gray-100">
        <h3 className="font-medium text-gray-800 mb-4">Notificaciones por Email</h3>
      ...
      {/* Notificaciones Push */}
      <div className="bg-gray-50 rounded-lg p-6 transition-all duration-300 hover:bg-gray-100">
        <h3 className="font-medium text-gray-800 mb-4">Notificaciones Push</h3>
        <div className="space-y-3">
      ...
      {/* Notificaciones SMS */}
      <div className="bg-gray-50 rounded-lg p-6 transition-all duration-300 hover:bg-gray-100">
        <h3 className="font-medium text-gray-800 mb-4">Notificaciones SMS</h3>
        <div className="space-y-3">
