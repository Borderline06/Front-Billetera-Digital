      ...
      <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm rounded-3xl shadow-2xl w-full max-w-md border border-sky-100 dark:border-slate-700 overflow-hidden animate-fade-in-up">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sky-100 text-sm">El líder revisará tu solicitud</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="px-6 py-4 bg-amber-50 dark:bg-amber-900/20 border-b border-amber-100 dark:border-amber-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-amber-800 dark:text-amber-300">Proceso de aprobación</p>
              <p className="text-xs text-amber-700 dark:text-amber-400">El líder del grupo debe aprobar tu solicitud</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="space-y-6">
            {/* Campo de Monto */}
            <div>
              <label htmlFor="amount_req" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-3">
                Monto a Solicitar (S/)
              </label>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-2">
                Ingresa el monto que deseas retirar del grupo
              </p>
            </div>

            {/* Campo de Razón */}
            <div>
              <label htmlFor="reason_req" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-3">
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  placeholder="Ej: Para la cena del grupo, Compra de materiales, Gastos personales, etc."
                />
              </div>
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-2">
                Explica brevemente el propósito del retiro para ayudar al líder en la revisión
              </p>
            </div>
            ...
            <div className="flex items-start gap-3 text-sm text-slate-600 dark:text-slate-400 bg-sky-50 dark:bg-sky-900/20 p-4 rounded-xl">
              ...
              <span>Tu solicitud será revisada por el líder del grupo. Recibirás una notificación cuando sea aprobada o rechazada.</span>
            </div>
        ...
        <div className="bg-sky-50 dark:bg-sky-900/10 px-6 py-4 border-t border-sky-100 dark:border-slate-700">
          <p className="text-xs text-slate-500 dark:text-slate-400 text-center">
            • Solicitud pendiente de aprobación • Notificación al líder • Proceso transparente •
          </p>
        </div>
      </div>
    </div>
